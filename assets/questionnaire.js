...
const G={
 ...
 interComm:[['أولًا: الاستفسارات وطلب التوضيحات',[['inter_comm_1','1. تتيح القنوات الرسمية للمواطنين توجيه استفساراتهم إلى الوزارة بشأن البرنامج.'],['inter_comm_2','2. تتيح القنوات الرسمية للمواطنين طلب توضيحات إضافية بشأن المعلومات المتعلقة بالبرنامج.'],['inter_comm_3','3. تُمكّن القنوات الرسمية المواطنين من مواصلة التواصل مع الوزارة عند الحاجة إلى معلومات أو توضيحات إضافية.']]]],
 interPart:[['ثانيًا: الملاحظات والمقترحات والشكايات المتعلقة بالبرنامج',[['inter_part_1','4. تتيح القنوات الرسمية للمواطنين تقديم ملاحظاتهم بشأن البرنامج.'],['inter_part_2','5. تتيح القنوات الرسمية للمواطنين تقديم مقترحات لتحسين البرنامج أو التواصل المرتبط به.'],['inter_part_3','6. تتيح القنوات الرسمية للمواطنين التعبير عن الصعوبات أو تقديم الشكايات المرتبطة بالبرنامج.']]]],
 ...
 communicationQuality:[['التواصل مع الوزارة بشأن البرنامج',[['communication_quality_global','1. بصفة عامة، أقيّم جودة تواصل الوزارة حول البرنامج تقييمًا إيجابيًا.']]]],
 ...
 legitimacy:[['آراؤكم حول بعض جوانب البرنامج',[['legit_1','1. تدخل الدولة من خلال برنامج الدعم المباشر للسكن مبرر بالنظر إلى صعوبات الولوج إلى السكن.'],['legit_2','2. تسهيل الولوج إلى السكن من خلال هذا البرنامج غاية اجتماعية تستحق الدعم.'],['legit_3','3. معايير الاستفادة المعتمدة في البرنامج عادلة.'],['legit_4','4. تخصيص موارد عمومية لتمويل البرنامج أمر مبرر.']]]],
 ease:[['شروط وإجراءات الاستفادة من البرنامج',[['ease_1','1. إجراءات طلب الاستفادة من البرنامج ميسرة بالنسبة للراغبين في الاستفادة.'],['ease_2','2. الوثائق المطلوبة للاستفادة من البرنامج يمكن توفيرها دون صعوبة كبيرة.'],['ease_3','3. شروط الاستفادة المحددة في البرنامج قابلة للاستيفاء بالنسبة للفئات المستهدفة.']]]],
 accept:[['آراؤكم حول البرنامج',[['accept_1','1. أؤيد تطبيق برنامج الدعم المباشر للسكن.'],['accept_2','2. أؤيد استمرار العمل ببرنامج الدعم المباشر للسكن.'],['accept_3','3. أوصي بالاستفادة من البرنامج للأشخاص المؤهلين لذلك.']]]],
 satisfaction:[['حول تجربتكم في الاستفادة من البرنامج',[['satisfaction_1','1. كانت تجربتي في الاستفادة من البرنامج مرضية.'],['satisfaction_2','2. أنا راضٍ عن الدعم الذي حصلت عليه في إطار البرنامج.'],['satisfaction_3','3. جاءت تجربتي في الاستفادة من البرنامج في مستوى توقعاتي.']]]],
 generalImpact:[['آثار البرنامج',[['impact_general_1','1. يسهم البرنامج في تسهيل اقتناء السكن بالنسبة للفئات المستهدفة.'],['impact_general_2','2. يسهم البرنامج في تخفيف العبء المالي المرتبط باقتناء السكن.'],['impact_general_3','3. يسهم البرنامج في تحسين الظروف السكنية للمستفيدين.']]]],
 success:[['آراؤكم حول البرنامج',[['success_global','بصفة عامة، أقيّم نجاح برنامج الدعم المباشر للسكن تقييمًا إيجابيًا.']]]],
...
const stepTitles={filters:'القسم الأول: معلومات حول علاقتكم بالبرنامج',information:'القسم الثاني: المعلومات الرسمية المتعلقة بالبرنامج',interaction:'القسم الثالث: التفاعل مع الوزارة بشأن البرنامج',understanding:'القسم الرابع: أسئلة حول برنامج الدعم المباشر للسكن',trust:'القسم الخامس: آراؤكم حول تدبير الوزارة للبرنامج',legitimacy:'القسم السادس: آراؤكم حول بعض جوانب البرنامج',evaluation:'القسم السابع: آراؤكم حول البرنامج',impact:'القسم الثامن: وضعكم السكني بعد الاستفادة من البرنامج',suggestions:'القسم التاسع: مقترحاتكم بشأن البرنامج',demographics:'القسم العاشر: معلومات عامة'};
function currentStepTitle(step){if(step==='interaction'&&route()==='g2')return'القسم الثالث: تجربتكم في التفاعل مع الوزارة';if(step==='trust'&&route()==='g2')return'القسم الخامس: آراؤكم حول تدبير الوزارة للبرنامج';return stepTitles[step];}
function steps(){
...
function interaction(){
 ...
 h+=`<section class="group-card"><div class="group-heading"><h3>${official?'ثالثًا: تجربتكم في التفاعل مع الوزارة':'القسم الثالث: تجربتكم في التفاعل مع الوزارة'}</h3></div>${radio('contact_reel','هل سبق لكم استخدام إحدى القنوات الرسمية للتواصل أو التفاعل بشأن البرنامج، لطرح سؤال أو طلب توضيح أو تقديم ملاحظة أو مقترح أو شكاية؟',['نعم','لا'])}`;
