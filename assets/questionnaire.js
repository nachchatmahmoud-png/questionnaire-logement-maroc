...
const SCHEMA_VERSION='2026-08-10-profils-g1-g5-v4-status-routing';
const ENTRY_COMMON={
...
const UNKNOWN_SCALE=[...SCALE,["لا أعرف / لا أستطيع التقييم","لا أعرف / لا أستطيع التقييم"]];
...
function interaction(){
 ...
 if(val('contact_reel')==='نعم'){h+=radio('canal_dernier_contact','من خلال أي قناة تم آخر تواصل لكم بشأن البرنامج؟',contactChannels);h+=radio('reponse_recue','هل توصلتم برد بشأن هذا التواصل؟',['نعم','لا']);if(val('reponse_recue')==='نعم')h+=`<p class="question-help">يرجى تقييم الرد الذي توصلتم به:</p>${table(G.response)}`;}
 h+='</section>';
...
const style=document.createElement('style');style.textContent=`.likert-wrap{overflow-x:auto}.likert-table{width:100%;border-collapse:collapse;min-width:760px;background:#fff}.likert-table.has-unknown{min-width:860px}.likert-table th,.likert-table td{border:1px solid rgba(15,23,42,.12);padding:.85rem;text-align:center}.likert-table th:first-child,.likert-table td:first-child{text-align:right;min-width:360px}.likert-table input{width:20px;height:20px}.likert-table thead th{font-weight:800;background:rgba(15,23,42,.04)}.group-card+.instruction-card{margin-top:1rem}@media(max-width:700px){.likert-wrap{overflow-x:auto;-webkit-overflow-scrolling:touch}.likert-table{width:100%;min-width:0;table-layout:fixed;border-collapse:collapse;background:#fff}.likert-table.has-unknown{width:900px;min-width:900px}.likert-table thead{display:table-header-group}.likert-table thead th{font-size:1.12rem;font-weight:800;padding-block:.85rem}.likert-table thead th:first-child{font-size:1.08rem}.likert-table tbody{display:table-row-group}.likert-table tr{display:table-row}.likert-table th,.likert-table td{display:table-cell;padding:.76rem .24rem;font-size:1rem;vertical-align:middle}.likert-table th:first-child,.likert-table td:first-child{display:table-cell;width:45%;min-width:0;padding:.95rem .6rem;text-align:right;line-height:1.75}.likert-table th:not(:first-child),.likert-table td:not(:first-child){width:11%;min-width:0;padding-inline:.08rem}.likert-table.has-unknown th:first-child,.likert-table.has-unknown td:first-child{width:36%}.likert-table.has-unknown th:not(:first-child),.likert-table.has-unknown td:not(:first-child){width:10.666%}.likert-table tbody td label{display:flex;width:100%;min-height:60px;align-items:center;justify-content:center}.likert-table input{width:28px;height:28px;margin:0}}@media(max-width:380px){.likert-table th,.likert-table td{padding:.6rem .12rem;font-size:.88rem}.likert-table thead th{font-size:.98rem;padding-block:.68rem}.likert-table thead th:first-child{font-size:.96rem}.likert-table th:first-child,.likert-table td:first-child{width:45%;padding:.78rem .38rem}.likert-table th:not(:first-child),.likert-table td:not(:first-child){width:11%}.likert-table.has-unknown th:first-child,.likert-table.has-unknown td:first-child{width:36%}.likert-table.has-unknown th:not(:first-child),.likert-table.has-unknown td:not(:first-child){width:10.666%}.likert-table input{width:25px;height:25px}}`;document.head.appendChild(style);
render();
