...
function understanding(){return `<div class="instruction-card"><strong>فهم البرنامج</strong><p class="instruction-text">يرجى اختيار جواب واحد لكل سؤال.</p></div>${quiz.map(([id,q,opts])=>radio(id,q,opts)).join('')}`}
