...
const SCHEMA_VERSION='2026-08-11-comprehension-v2';
const ENTRY_COMMON={
...
const quiz=[
 ['understanding_1','1. ما الذي تتيحه منصة «دعم سكن» للراغبين في الاستفادة من البرنامج؟',['البحث عن مساكن للبيع وحجزها','الحصول على قرض سكني من البنك','تقديم طلب الاستفادة وتتبع مراحل الملف','أداء ثمن السكن عبر المنصة'],'تقديم طلب الاستفادة وتتبع مراحل الملف'],
