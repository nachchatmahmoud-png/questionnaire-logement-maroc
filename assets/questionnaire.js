...
function interaction(){
 ...
 let h=official?`<div class="instruction-card interaction-channels-card"><p>يرجى الإجابة بناءً على معرفتكم أو تجربتكم مع <strong>قنوات التواصل الرسمية التي تتيح التفاعل بشأن برنامج «دعم سكن»</strong>، والتي تشمل:</p><ul class="official-channel-list"><li><strong>منصة دعم سكن – <bdi dir="ltr">DaamSakane.ma</bdi></strong>: عبر خدمة <strong>«اتصل بنا»</strong> المتاحة على المنصة الرسمية.</li><li><strong>الموقع الرسمي للوزارة – <bdi dir="ltr">mhpv.gov.ma</bdi></strong>: عبر <strong>نموذج الاتصال أو خدمة التواصل</strong> المتاحة على الموقع الرسمي للوزارة.</li><li><strong>البوابة الوطنية للشكايات – <bdi dir="ltr">Chikaya.ma</bdi></strong>: عبر <strong>إيداع أو متابعة شكاية رسمية</strong>.</li><li><strong>الهاتف / مركز الاتصال الرسمي</strong>: عبر الرقم <strong><bdi dir="ltr">+212 5 37 71 81 81</bdi></strong>.</li><li><strong>البريد الإلكتروني الرسمي</strong>: عبر <strong><a href="mailto:contact@daamsakane.ma"><bdi dir="ltr">contact@daamsakane.ma</bdi></a></strong>.</li><li><strong>شبكات التواصل الاجتماعي الرسمية للوزارة</strong>: عبر <strong>Facebook أو Instagram أو باقي الحسابات الرسمية للوزارة</strong>، من خلال الرسائل الخاصة أو التعليقات.</li></ul></div>${scaleLegend()}${table(G.interComm)}${table(G.interPart)}`:`<div class="instruction-card compact"><p>يجيب المشارك هنا فقط عن تجربة تواصل فعلية مع الوزارة بشأن البرنامج.</p></div>`;
