...
function requiredIds(step){
 ...
 if(step==='demographics'){let ids=['age','gender','education','housing','residence','professional'];if(val('education')==='التعليم العالي')ids.push('education_higher_detail');if(val('residence')==='داخل المغرب')ids.push('region');if(val('residence')==='خارج المغرب')ids.push('country');return ids;}
 return[];
}
