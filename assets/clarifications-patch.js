(() => {
  ...
  const sectionThreeStatements = new Map([
    ...
    [
      ...
      "بصفة عامة، تسهّل وسائل التواصل الرسمية التي تتيح التفاعل تواصل المواطنين مع الوزارة بشأن البرنامج",
    ],
    [
      "بصفة عامة، أقيّم جودة تواصل الوزارة حول البرنامج تقييمًا إيجابيًا",
      "بصفة عامة، أشعر بالرضا عن جودة تواصل الوزارة بشأن البرنامج",
    ],
  ]);
