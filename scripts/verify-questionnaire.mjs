...
expect(source.includes("const AUTH_BRIDGE_URL='https://script.google.com/macros/s/AKfycbz-hahg33fWgInRnwSYXmkZpYIiniKB0OIDpugCxvMxwcuN1UrL0jyYJ3AlNPK0jA_Wvg/exec'"), 'Le site doit utiliser le déploiement Apps Script actif.');
