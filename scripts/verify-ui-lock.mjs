...
expect(source.includes('س2-ب. ما السبب الرئيسي لعدم اطلاعكم على معلومات حول البرنامج عبر القنوات الرسمية للوزارة؟'), 'La numérotation س2-ب doit être conservée.');
