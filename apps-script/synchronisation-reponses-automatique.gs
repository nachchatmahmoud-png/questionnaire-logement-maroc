...
const REPONSES_CORRECTES_COMPREHENSION = Object.freeze({
  '1. ما الغاية الأساسية من برنامج الدعم المباشر للسكن؟':
    'مساعدة الأشخاص المؤهلين على اقتناء سكن رئيسي من خلال دعم مالي مباشر',
  '2. أي من الشروط التالية يجب أن يتوفر في الشخص للاستفادة من برنامج الدعم المباشر للسكن؟':
  ...
  '6. ما المدة التي يجب أن يبقى خلالها السكن مخصصًا للسكن الرئيسي ابتداءً من تاريخ إبرام عقد البيع النهائي؟':
    'خمس (5) سنوات'
});
