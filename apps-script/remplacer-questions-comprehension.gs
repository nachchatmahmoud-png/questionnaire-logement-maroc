...
function remplacerQuestionsComprehension() {
  ...
  const definitions = [
    {
      anciensTitres: ['1. ما الذي يقدمه برنامج الدعم المباشر للسكن؟'],
      titre: '1. ما الذي تتيحه منصة «دعم سكن» للراغبين في الاستفادة من البرنامج؟',
      choix: ['البحث عن مساكن للبيع وحجزها', 'الحصول على قرض سكني من البنك', 'تقديم طلب الاستفادة وتتبع مراحل الملف', 'أداء ثمن السكن عبر المنصة']
    },
    {
